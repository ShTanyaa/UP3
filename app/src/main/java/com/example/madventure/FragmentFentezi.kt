 ...
 * Use the [FragmentFentezi.newInstance] factory method to
 * create an instance of this fragment.
 */
class FragmentFentezi : Fragment() {
    ...
    override fun onCreateView(
        ...
        // Inflate the layout for this fragment
        val fragmentLayout = inflater.inflate(R.layout.fragment_fentezi, container, false)
    ...
    private inner class FetchMoviesTask(val fragmentLayout: View) : AsyncTask<Void, Void, String>() {
        override fun doInBackground(vararg params: Void?): String? {
            ...
            try {
                ...
                val apiUrl = "https://www.omdbapi.com/?apikey=$apiKey&s=fantasy&type=movie&plot=full"
    ...
    companion object {
         ...
         * @return A new instance of fragment FragmentFentezi.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            FragmentFentezi().apply {
