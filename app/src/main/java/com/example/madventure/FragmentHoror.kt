    ...
    private inner class FetchMoviesTask(val fragmentLayout: View) : AsyncTask<Void, Void, String>() {
        override fun doInBackground(vararg params: Void?): String? {
            ...
            try {
                ...
                val apiUrl = "https://www.omdbapi.com/?apikey=$apiKey&s=horror&type=movie&plot=full"
                ...
                if (data.containsKey("Search")) {
                    ...
                    top5HorrorMovies.forEach { movie ->
                        ...
                        if(answer.size == 5){
                            ...
                            Log.d(TAG, name + " " + img + " " + info)
                        }

                    }
                } else {
                    Log.e(TAG, "Не удалось получить данные. Пожалуйста, проверьте ваш API-ключ и запрос.")
                }
            }
        }
